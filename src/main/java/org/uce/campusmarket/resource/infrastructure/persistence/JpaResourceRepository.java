...
public interface JpaResourceRepository extends JpaRepository<ResourceJpaEntity, UUID> {
    ...
    List<ResourceJpaEntity> findByTitleContainingIgnoreCaseOrDescriptionContainingIgnoreCase(String title,
            String description);
    ...
    List<ResourceJpaEntity> findByTitleContainingIgnoreCaseAndCategoryOrDescriptionContainingIgnoreCaseAndCategory(
            String title, String category1, String description, String category2);
}
