...
public class SearchResourcesUseCase {

    private final ResourceRepository resourceRepository;
    private final UserRepository userRepository;

    public List<ResourceResponse> execute(String keyword, String category) {
        
        List<Resource> resources = resourceRepository.search(keyword, category);
